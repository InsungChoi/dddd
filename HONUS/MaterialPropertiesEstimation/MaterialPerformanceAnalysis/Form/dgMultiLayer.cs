...
//			lstLayerList.Columns.Add(col);
		...
		private void InitializeComponent()
		{
			...
			this.edtStructureFactor.TabIndex = 12;
			...
			this.edtViscousCharLength.TabIndex = 14;
			...
			this.edtThermalCharLength.TabIndex = 15;
			...
			this.edtPoissionsRatio.TabIndex = 9;
			...
			this.edtYoungsModulus.TabIndex = 82;
			...
			this.edtLossFactor.TabIndex = 10;
			...
			this.edtFlowResistivity.TabIndex = 11;
			...
			this.groupBox2.Text = "Acoustical Material";
